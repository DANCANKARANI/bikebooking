          ...
          <section className="bg-white p-8 rounded-lg shadow-md">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-gray-100 p-6 rounded-lg text-center">
                <img src="/team-member1.jpg" alt="Team Member 1" className="w-32 h-32 mx-auto mb-4 rounded-full object-cover" />
              ...
              <div className="bg-gray-100 p-6 rounded-lg text-center">
                <img src="/team-member2.jpg" alt="Team Member 2" className="w-32 h-32 mx-auto mb-4 rounded-full object-cover" />
              ...
              <div className="bg-gray-100 p-6 rounded-lg text-center">
                <img src="/team-member3.jpg" alt="Team Member 3" className="w-32 h-32 mx-auto mb-4 rounded-full object-cover" />
